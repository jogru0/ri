...
#[ignore = "slow"]
fn aoc17g() {
    run("res/aoc/17g.ri", "108107574778365");
}
...
#[test]
fn aoc19g() {
    run("res/aoc/19g.ri", "848076019766013");
}
...
#[test]
fn aoc21g() {
    run("res/aoc/21g.ri", "228800606998554");
}

#[test]
fn aoc22s() {
    run("res/aoc/22s.ri", "19927218456");
}
...
#[test]
fn aoc23g() {
    run("res/aoc/23g.ri", "cb,df,fo,ho,kk,nw,ox,pq,rt,sf,tq,wi,xz");
}

#[test]
fn aoc24s() {
    run("res/aoc/24s.ri", "48063513640678");
}

#[test]
#[ignore = "slow"]
fn aoc24g() {
    run("res/aoc/24g.ri", "hqh,mmk,pvb,qdq,vkq,z11,z24,z38");
}
